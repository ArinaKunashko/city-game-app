<template>
    <div class="flex justify-center items-center vh100">
        <div class="block rounded-2xl shadow-lg bg-white max-w-xl">
            <div class="prose py-3 px-6 border-b-2 border-gray-100 text-center">
                <h4 class="font-normal">Игра в города на время</h4>
            </div>
            <div class="p-6 flex flex-col items-center">
                <article class="prose">
                    ...
                    <ul prose-ul>
                        ...
                        <li class="prose-li">
                            Названий городов на твердый "ъ" или мягкий "ь" знак нет. Из-за этого мы пропускаем эту букву и
                            игрок
                            должен
                ...
                <button type="button" class="focus:outline-none text-white bg-purple-700
                             hover:bg-purple-800 focus:ring-4
                              focus:ring-purple-300 font-medium rounded-lg text-sm px-5 py-2.5 mb-2
                               dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-900 w-32"
                               >
